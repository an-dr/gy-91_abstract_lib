...
#define MOT_DUR           0x20 // Zero-motion detection threshold bits [7:0], LSB = 1 ms
...
//    virtual uint8_t writeByte(uint8_t deviceAddress, uint8_t data) = 0;
    ...
    gy91i2c(uint8_t i2c_address = MPU9250_ADDRESS_AD0, uint32_t i2c_freq = 100000);
    void getMres();
    void getGres();
    void getAres();
